...
# 
# write_rds(url_tbl, "saved_data/url_tbl_20180724.rds")

# Read Saved url_tbl
url_tbl <- read_rds("saved_data/url_tbl_20180724.rds")

# already downloaded as of 2018 07 24 
#################################################################################
...
# 
# write_rds(json_list, "saved_data/json_list_20180930.rds")

json_list <- read_rds("saved_data/json_list_20180930.rds")

# # Saved on 2018 09 30
# posts_list <- par_process_json_list(json_list)
# posts_tbl <- as_tibble(do.call(rbind, posts_list))
# 
# write_rds(posts_tbl, "saved_data/posts_tbl_20180930.rds")

posts_tbl <- read_rds("saved_data/posts_tbl_20180930.rds")
...
# 
# 
# posts_tbl_processed %>% write_csv(path = "saved_data/posts_tbl_processed_20180930.csv")
